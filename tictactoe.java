...
public class TTTConsoleNonOO2P {
   ...
   public static int ROWS = 3; // number of rows and columns
   // The game board and the game status
   ...
   public static void main(String[] args) {
      ...
      do{
        ...
        exitGame();
      } while (currentState != EXIT); // repeat if not exit the game
   }
   /** Initialize the game-board contents dynamically */
   public static void initBoard() {
      boolean validInput = false;  // for input validation
      do {
         System.out.print("Welcome to Tic Tac Toe ... ");
         System.out.print("Please enter your board (row column) with min is 3 : ");
         int row = in.nextInt();  
         int col = in.nextInt();
         if(row >= 3 && col >= 3){
            ROWS=row;
            ...
            System.out.println("Get started ...");
             ...
             System.out.println("Min board is 3, please try again...");
         }
